...
func ExampleBeNilf() {
	BeNilf(t, new(uint32(13)), "extra message: %s", "foo")
...
func ExampleNotBeNilf() {
	NotBeNilf(t, nil, "extra message: %s", "foo")
...
func ExampleBeZerof() {
	BeZerof(t, 13, "extra message: %s", "foo")
...
func ExampleNotBeZerof() {
	NotBeZerof(t, 0, "extra message: %s", "foo")
...
func ExampleErrorf() {
	Errorf(t, nil, "extra message: %s", "foo")
...
func ExampleNoErrorf() {
	NoErrorf(t, errors.New("boom"), "extra message: %s", "foo")
